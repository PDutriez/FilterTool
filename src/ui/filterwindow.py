...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.EventsShower = QtWidgets.QScrollArea(self.groupBox)
        self.EventsShower.setGeometry(QtCore.QRect(10, 220, 741, 141))
        self.EventsShower.setWidgetResizable(True)
        self.EventsShower.setObjectName("EventsShower")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 737, 137))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.EventsShower.setWidget(self.scrollAreaWidgetContents)
        self.GraphZone.addWidget(self.groupBox)
        self.horizontalLayout.addLayout(self.GraphZone)

        self.retranslateUi(MainWindow)
        self.GraphsWidget.setCurrentIndex(4)
